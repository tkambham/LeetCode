<h2><a href="https://leetcode.com/problems/max-pair-sum-in-an-array/?envType=problem-list-v2&envId=array">2815. Max Pair Sum in an Array</a></h2><h3>Easy</h3><hr><p>You are given an integer array <code>nums</code>. You have to find the <strong>maximum</strong> sum of a pair of numbers from <code>nums</code> such that the <strong>largest digit </strong>in both numbers is equal.</p>
